  ...
  <div class="page-container">
    ...
    <main class="page-content">
      <div class="analytics-content">
        ...
        <div v-if="selectedDate" class="selection-summary">
...
.select-control:hover, .date-control:hover {
  border-color: #cbd5e0;
}

.select-control:focus, .date-control:focus {
  outline: none;
  border-color: #4299e1;
      ...
      <div class="content-wrapper">
        <div class="stat-cards-row">
          <div class="stat-card" style="background-color: #2563eb">
            <h3>Availability</h3>
            <p class="stat-value">{{ stats.availability }}%</p>
          </div>
          <div class="stat-card" style="background-color: #0891b2">
            <h3>Performance</h3>
            <p class="stat-value">{{ stats.performance }}%</p>
          </div>
          <div class="stat-card" style="background-color: #4f46e5">
            <h3>Quality</h3>
            <p class="stat-value">{{ stats.quality }}%</p>
          </div>
          <div class="stat-card" style="background-color: #059669">
            <h3>OEE</h3>
            <p class="stat-value">{{ stats.oee }}%</p>
          </div>
        </div>
...
/* New wrapper to control content width */
.content-wrapper {
  /* Remove the centering */
  max-width: 800px;
  margin: 0;
  padding-left: 1.5rem; /* Align with the red mark position */
}
